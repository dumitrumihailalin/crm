                    ...
                    <div class="col-md-6 p-lg-5 pt-5 pb-5">
                        <form action="/categories/save" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="category_name" id="category_name" placeholder="Categorie">
                            </div>
                            <div class="form-group">
                                <label>Status</label>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="category_status" id="category_status1" checked>
                                    <label class="form-check-label" for="category_status1">
                                        Activ
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="category_status" id="category_status2">
