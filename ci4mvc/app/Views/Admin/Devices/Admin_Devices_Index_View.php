...
<div id="wrapper">
    ...
    {
        $current = \CodeIgniter\I18n\Time::parse('Europe/Bucharest');
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <?php foreach($devices as $device): ?>
                                    <tr>
                                        ...
                                        <td><?php echo - humanTiming($device['created_at']) == 0 ? 1 :   - humanTiming($device['created_at']); ?></td>
                                        <td><?php echo $device['created_at']; ?></td>
                                        <td><small class="<?php echo 'bg-'.$device['status_bg']; ?> p-2 border-radius status"><?php echo $device['status_name']; ?></small></td>
                                        <td>
                                            <a href="/devices/edit/<?php echo $device['device_id']; ?>" alt="Editeaza" class="btn btn-primary btn-sm">
                                                <i class="fas fa-fw fa-pen"></i>
                                            </a>
                                            <a href="/devices/delete/<?php echo $device['device_id']; ?>" alt="Sterge" class="btn btn-danger btn-sm">
