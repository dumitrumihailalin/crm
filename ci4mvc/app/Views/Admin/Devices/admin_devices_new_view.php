...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">LapServ <sup>admin</sup></div>
        </a>
                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Client nou</h1>
                                </div>
                                <form class="user" action="<?php echo base_url(); ?>/devices/create" method="get">
                                    ...
                                    <input type="submit" class="btn btn-primary btn-user btn-block" value="Adauta">
                                </form>
                            </div>
